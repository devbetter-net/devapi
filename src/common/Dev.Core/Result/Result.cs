...
namespace Dev.Core.Result
{
    public class Result<T> : IResult
    {
        ...
        [JsonInclude] 
        public IEnumerable<ValidationError> ValidationErrors { get; protected set; } = new List<ValidationError>();
        ...
        {
            return this.Value ?? throw new InvalidOperationException("Value is null.");
        }
        ...
        {
            return new Result<T>(ResultStatus.Invalid) { ValidationErrors = new List<ValidationError> { validationError } };
        }
